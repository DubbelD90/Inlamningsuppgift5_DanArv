...
namespace DeviceApp
{
    class Program
    {
        private static DeviceClient deviceClient = DeviceClient.CreateFromConnectionString("HostName=ec-win20-danarv.azure-devices.net;DeviceId=DeviceApp;SharedAccessKey=oX1T0avW+ikvoo3oy57gXCchScQjN7acAhRBVbwmHn0=", TransportType.Mqtt);
